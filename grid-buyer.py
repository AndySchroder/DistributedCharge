...
from dc.RateFunctions import SetInterpolator,CheckRateAllowable,MeterMonitor,RateFile		#uses TimeStampedPrint, so do this import away from the rest of the modules
